...
func tableScalingoAddon() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "provisioned_at", Type: proto.ColumnType_DATETIME, Description: "When the addon has been created."},
			{Name: "deprovisioned_at", Type: proto.ColumnType_DATETIME, Description: "When the addon has been removed/upgraded."},
